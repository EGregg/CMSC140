...
Lessons Learned:
1. I Learned the importance of reading the directions beforehand carefully about what variables will be required to include in the program.
2. Learned further the usefulness of fixed and setprecision. Was stuck on trying manipulate the numbers by dividing and trying to get a decimal. The correct way was to use fixed and setprecision(1).
3. Learned further when to include <iomanip>. First tried to use setprecision without including the library in the preprocessor.
4. Inserting bits of my pseudocode in comments is very useful for keeping my programming on task.
*/
